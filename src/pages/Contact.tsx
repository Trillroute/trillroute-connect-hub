                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">2nd Floor, JK Plaza, 788</p>
                        <p className="text-gray-600">12th Main Rd, HAL 2nd Stage</p>
                        <p className="text-gray-600">Doopanahalli, Indiranagar</p>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">hello@trillroute.com</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">080 4748 8000</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
            ...
            <div className="w-full h-[400px] rounded-xl overflow-hidden shadow-lg">
              <div className="w-full h-full bg-gray-200 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-gray-500 text-sm">2nd Floor, JK Plaza, 788</p>
                </div>
              </div>
            </div>
          </div>
